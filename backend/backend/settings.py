...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Palitan kung may auth
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication',
        # 'rest_framework_simplejwt.authentication.JWTAuthentication',  # Kung gagamit ng JWT
    ],
}
...
if not DEBUG:
    ...
    SECURE_HSTS_SECONDS = 3600  # 1 hour (increase to 31536000 for production)
    SECURE_HSTS_INCLUDE_SUBDOMAINS = True
    SECURE_HSTS_PRELOAD = True

# 📧 EMAIL CONFIG (Optional - for password reset, etc.)
...
# 🪵 LOGGING (Basic console logging for Render)
LOGGING = {
    'version': 1,
